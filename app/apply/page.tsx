...
export default function ApplyPage() {
  ...
  useEffect(() => {
    const checkAuthAndLoadDraft = async () => {
      try {
        ...
        const resumeDraftRaw =
          typeof window !== "undefined"
            ? sessionStorage.getItem("resumeDraft")
            : null;
        if (resumeDraftRaw) {
          try {
            ...
            setFormData({
              ...
              facultyInvolved:
                draftApp.faculty_involved === "NA" || !draftApp.faculty_involved
                  ? []
                  : Array.isArray(draftApp.faculty_involved)
                    ? draftApp.faculty_involved
                    : [],
              priorEntrepreneurshipExperience:
                draftApp.prior_entrepreneurship_experience || "",
              teamPriorEntrepreneurshipExperience:
                draftApp.team_prior_entrepreneurship_experience || "",
              ...
              teamMembers: (() => {
                ...
                const coCount = Math.max(
                  0,
                  parseInt(String(draftApp.co_founders_count || "0"), 10) || 0,
                );
                return raw.map((m: Record<string, unknown>, i: number) => ({
                  ...
                  contactNumber:
                    m.contact_number ??
                    (m as { contactNumber?: string }).contactNumber ??
                    "",
              ...
              hasPotentialIntellectualProperty:
                draftApp.has_potential_intellectual_property || "",
              ...
              seedFundUtilizationPlan:
                draftApp.seed_fund_utilization_plan || "",
            ...
            addToast({
              variant: "default",
              description:
                "Draft loaded from resume link. Continue where you left off.",
            });
          } catch (e) {
            console.error(
              "Failed to load resume draft from sessionStorage:",
              e,
            );
          }
  ...
  const handleSaveDraft = async (silent = false) => {
    try {
      ...
      const payload: Record<string, unknown> = {
        ...
        priorEntrepreneurshipExperience:
          formData.priorEntrepreneurshipExperience,
        teamPriorEntrepreneurshipExperience:
          formData.teamPriorEntrepreneurshipExperience,
        ...
        hasPotentialIntellectualProperty:
          formData.hasPotentialIntellectualProperty,
  ...
  const clearDraft = async () => {
    if (draftId) {
      try {
        await supabase.from("new_application").delete().eq("id", draftId);
      } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formData.teamMembers.forEach((member, index) => {
      ...
      if (teamEmail && !/\.(com|in)$/.test(teamEmail)) {
        newErrors[`teamEmail_${index}`] =
          "Team member email must end with .com or .in";
      }
    });
    ...
    if (missingFields.length > 0) {
      setIsSubmitting(false);
      const radioErrorMessages = missingFields.map(
        (label) => `Please select an option for: ${label}`,
      );
      const description =
        radioErrorMessages.length === 1
    ...
    try {
      ...
      if (ipFile) {
        ...
        console.log(
          "No IP file to add. hasIntellectualProperty:",
          formData.hasIntellectualProperty,
        );
      }
      if (potentialIpFile) {
        ...
        console.log(
          "No potential IP file to add. hasPotentialIntellectualProperty:",
          formData.hasPotentialIntellectualProperty,
        );
      }
            ...
            <div className="flex items-center justify-between w-full max-w-4xl">
              <div>
                ...
                <p className="text-lg text-zinc-600 dark:text-zinc-400">
                  Apply to join Nirmaan's pre-incubation program. Fill out the
              ...
              <AlertDescription className="flex items-center justify-between">
                ...
                <Button
                  ...
                  onClick={async () => {
                    if (
                      confirm(
                        "Are you sure you want to clear the draft and start over?",
                      )
                    ) {
                      await clearDraft();
              ...
              <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => {
                          ...
                          if (fieldErrors.currentOccupation)
                            setFieldErrors((prev) => {
                              const next = { ...prev };
                      ...
                      >
                        <SelectTrigger
                          ...
                          className={cn(
                            fieldErrors.currentOccupation && "border-red-500",
                          )}
                        >
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger
                      id="channel"
                      className={cn(fieldErrors.channel && "border-red-500")}
                    >
                        ...
                        <tbody>
                          {formData.facultyInvolved.length === 0 ? (
                            <tr>
                              ...
                              >
                                No faculty members added. Click the Add button
                                below to add one.
                              </td>
                            </tr>
                          ) : (
                              ...
                              >
                                ...
                                <td className="px-3 py-2 text-center">
                                  <button
                                    ...
                                    onClick={() => {
                                      const updated =
                                        formData.facultyInvolved.filter(
                                          (_, i) => i !== index,
                                        );
                                      setFormData((prev) => ({
                                        ...prev,
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="priorExperienceDetails">
                    Please provide a brief idea about your prior experience or
                    your team's prior experience as an entrepreneur. Do share
                    any links to demos or websites or reports that could help us
              ...
              <CardContent className="space-y-4">
                          ...
                          {formData.externalFunding.length === 0 ? (
                            <tr>
                              <td
                                ...
                                className="px-3 py-4 text-center text-sm text-zinc-500 dark:text-zinc-400"
                              >
                                No funding entries added. Click the Add button
                                below to add one.
                              </td>
                            </tr>
                          ) : (
                              ...
                              >
                                  ...
                                  <div>
                                    <Input
                                      ...
                                      onChange={(e) => {
                                        ...
                                        if (fieldErrors[`fundAmount_${index}`])
                                          setFieldErrors((prev) => {
                                            const next = { ...prev };
                                ...
                                <td className="px-3 py-2 text-center">
                                  <button
                                    ...
                                    onClick={() => {
                                      const updated =
                                        formData.externalFunding.filter(
                                          (_, i) => i !== index,
                                        );
                                      setFormData((prev) => ({
                                        ...prev,
                ...
                <div className="space-y-2">
                  <Label htmlFor="currentlyIncubated">
                    Is the startup currently incubated anywhere? (If yes write
                    the name or else write no)
                  </Label>
                  <Input
                          ...
                          {formData.teamMembers.length === 0 ? (
                            <tr>
                              <td
                                ...
                                className="px-3 py-4 text-center text-sm text-zinc-500 dark:text-zinc-400"
                              >
                                No team members added. Click the Add button
                                below to add one.
                              </td>
                            </tr>
                          ) : (
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger
                      id="solutionType"
                      className={cn(
                        fieldErrors.solutionType && "border-red-500",
                      )}
                    >
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger
                      id="targetIndustry"
                      className={cn(
                        fieldErrors.targetIndustry && "border-red-500",
                      )}
                    >
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="nirmaanPresentationLink">
                    Upload your Nirmaan Presentation as per the Template. (Max
                    10 MB size){" "}
                    <a
