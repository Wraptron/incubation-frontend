...
function UsersPage() {
    ...
    const fetchUsers = async ()=>{
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("user_profiles").select("*").order("created_at", {
                ascending: false
            });
            if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6c995f85._.js.map