...
function ApplicationDetailPage() {
    ...
    const fetchAllEvaluations = async ()=>{
        ...
        try {
            const backendUrl = ("TURBOPACK compile-time value", "http://localhost:5000") || "http://localhost:5000";
            const response = await fetch(`${backendUrl}/api/evaluations/application/${params.id}/all`);
            if (response.ok) {
                const data = await response.json();
    ...
    const fetchReviewerEvaluation = async ()=>{
        ...
        try {
            ...
            if (!session) return;
            const backendUrl = ("TURBOPACK compile-time value", "http://localhost:5000") || "http://localhost:5000";
            const response = await fetch(`${backendUrl}/api/evaluations/application/${params.id}`, {
                headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__03927a9f._.js.map