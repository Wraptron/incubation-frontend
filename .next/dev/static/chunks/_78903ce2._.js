...
"[project]/app/applicant-login/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (data.user) {
                ...
                const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("applicant_profiles").select("*").eq("id", data.user.id).single();
                if (!profile) {
...
_s(ApplicantLoginPage, "IDdAwE1guEJWGfy6FqV4wWXev98=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = ApplicantLoginPage;
var _c;
__turbopack_context__.k.register(_c, "ApplicantLoginPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_78903ce2._.js.map