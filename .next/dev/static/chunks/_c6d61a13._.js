...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (data.user) {
                // Check user role
                const { data: profile, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("user_profiles").select("role").eq("id", data.user.id).single();
...
//# sourceMappingURL=_c6d61a13._.js.map