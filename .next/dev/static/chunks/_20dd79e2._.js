...
function DashboardPage() {
    ...
    const fetchApplications = async ()=>{
        try {
            ...
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["backendUrl"]}/api/applications${params}`);
            if (response.ok) {
...
//# sourceMappingURL=_20dd79e2._.js.map