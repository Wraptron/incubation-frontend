        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.evaluation) {
                    ...
                    // Populate form with existing evaluation
                    setFormData({
                        needScore: data.evaluation.need_score?.toString() || "",
                        noveltyScore: data.evaluation.novelty_score?.toString() || "",
                        feasibilityScalabilityScore: data.evaluation.feasibility_scalability_score?.toString() || "",
                        marketPotentialScore: data.evaluation.market_potential_score?.toString() || "",
                        impactScore: data.evaluation.impact_score?.toString() || "",
    ...
    const handleSave = async (isDraft = false)=>{
        ...
        for (const scoreKey of requiredScores){
            if (!formData[scoreKey] || formData[scoreKey].trim() === "") {
                setSaveMessage("Please provide scores for all criteria (1-10)");
...
_s(EvaluatePage, "pdSZWNlrvblIBbHzP3eUcVYbQ14=", false, function() {
    return [
...
//# sourceMappingURL=_72271f20._.js.map